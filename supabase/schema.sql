-- Run this in Supabase SQL Editor before using the online catalog.
-- The frontend reads these tables with the publishable key.
...
-- Grant API access after confirming these tables are exposed in Supabase Data API settings.
